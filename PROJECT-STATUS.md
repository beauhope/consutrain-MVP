...
## 2026-06-15 - French ISO consulting service detail page

Status: Completed

- Created `fr/services/iso-consulting.html` as a selected French service detail page.
- Added breadcrumbs, a "Dans cette page" internal summary, clear CTA links, and the correct AR language link.
...
## 2026-06-15 - French project management service detail page

Status: Completed

- Created `fr/services/project-management.html` as a selected French service detail page.
- Added breadcrumbs, a "Dans cette page" internal summary, clear CTA links, and the correct AR language link.
- Linked the French Services page and French homepage project management cards to the new detail page.
- Added a page-level FR language override on the Arabic project management page.

## 2026-06-15 - French SOP and operational manuals service detail page

Status: Completed

- Created `fr/services/sop-operational-manuals.html` as a selected French service detail page.
- Added breadcrumbs, a "Dans cette page" internal summary, clear CTA links, and the correct AR language link.
...
## 2026-06-15 - French digital transformation roadmap service detail page

Status: Completed

- Created `fr/services/digital-transformation-roadmap.html` as a selected French service detail page.
- Added breadcrumbs, a "Dans cette page" internal summary, clear CTA links, and the correct AR language link.
